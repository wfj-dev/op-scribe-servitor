...
from opscribe.constants import KILL_LOG_REVIEW_DELAY_MINUTES
...
def test_verify_inside_cooldown_shows_two_minute_message_for_aar_participant():
    ...
    assert (
        args[0]
        == f"Kill log entries cannot be verified until {KILL_LOG_REVIEW_DELAY_MINUTES} minutes after submission."
    )
