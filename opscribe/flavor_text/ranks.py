...
RANK_HONORIFICS: Dict[str, str] = {
    ...
    "Blademaster": "Blade of the Fortress, Blademaster",
...
SOK_G_PIPEHITTER_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster as Pipehitter — the title and the designation share the same blade.",
...
DISTINGUISHED_PIPEHITTER_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's blade and the Pipehitter's mark grow more deeply joined with each operation.",
...
BLACK_LAURELS_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's Black Laurels is the blade laid down — for the Kill Team, before any foe.",
...
CRUX_TERMINATUS_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster in venerated plate is the Watch's heaviest blade — and the Crux confirms it.",
...
KADAKU_CAMPAIGN_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's blade fell at every Kadaku front — Leviathan met its match in the title and the warrior alike.",
...
BLACK_REEF_CAMPAIGN_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's blade fell at every Reef-front — the title and the warrior in perfect alignment.",
...
DISTINGUISHED_BLACK_REEF_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's Distinguished Reef service is the blade laid alongside every brother's, never above.",
...
ORDER_OMEGA_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster in The Order Omega is the heaviest blade laid alongside every brother's at the impossible difficulty.",
...
DUAL_VIGIL_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's Order of the Aquiline Brotherhood is the executioner's blade sharpened by partnership — one brother at the side, every absolute mission.",
...
TERMINUS_SLAYER_ASSAULT_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster who interprets the execution mandate as a jump pack charge at close-quarters distance has interpreted it correctly.",
...
TERMINUS_SLAYER_BULWARK_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster who works from behind a banner has not abandoned the mandate — they have staged it. The shield absorbs; the blade executes on schedule.",
...
TERMINUS_SLAYER_HEAVY_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster behind the barrier with sustained heavy fire has determined that the warrant does not require proximity. Maximum range and maximum firepower produce the same finality.",
...
TERMINUS_SLAYER_SNIPER_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster who delivers the warrant from concealment has found the most final form of execution — the target has no opportunity to contest the order, no way to locate the officer, and no forewarning whatsoever.",
...
TERMINUS_SLAYER_TACTICAL_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's mandate specifies no preferred method. Versatility is the fullest expression of that mandate — the auspex identifies the weakpoint; the weapon is selected accordingly.",
...
TERMINUS_SLAYER_TECHMARINE_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster who makes the Tarantula Sentry Gun the instrument of the warrant has found the most mechanical form of execution — the zone built, the machine-spirit aimed, the result independent of the blade.",
...
TERMINUS_SLAYER_VANGUARD_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster who closes by grapnel has delivered the warrant at the speed it deserves — the target reached before it could prepare, the outcome settled at the range the grapnel selected.",
...
MASTER_TERMINUS_SLAYER_RANK_LINES: Dict[str, str] = {
    ...
    "Blademaster": "The Blademaster's Master Terminus Slayer record is the execution mandate applied across six disciplines — the Watch's highest combat title at the Watch's highest kill tier.",
