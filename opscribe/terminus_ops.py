...
async def _challenge_progress_inner(
    ...
    challenge_rows = [
        ...
        ("Octavian Operation Medal",           "octavian_incident",     OCTAVIAN_INCIDENT_REQUIRED_MISSIONS,            OCTAVIAN_OPERATION_MEDAL_ROLE_ID),
        ("Distinguished Octavian",             "distinguished_octavian_incident", OCTAVIAN_INCIDENT_REQUIRED_MISSIONS, DISTINGUISHED_OCTAVIAN_OPERATION_MEDAL_ROLE_ID),
