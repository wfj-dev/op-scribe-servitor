...
TERMINUS_SLAYER_ASSAULT_RANK_LINES: Dict[str, str] = {
    ...
    "Lord Executioner": "The Lord Executioner who interprets the execution mandate as a jump pack charge at close-quarters distance has interpreted it correctly.",
    ...
    "Kill Team Champion": "The Kill Team Champion who closes beneath jump pack thrust leads the charge the team cannot. The killing blow at the end of it makes the result available to everyone.",
...
TERMINUS_SLAYER_BULWARK_RANK_LINES: Dict[str, str] = {
    ...
    "Kill Team Champion": "The Kill Team Champion who takes up the shield and banner gives the team everything the shield and banner offer, and then gives the team one more thing — the blade drawn when the position has served its purpose.",
...
TERMINUS_SLAYER_SNIPER_RANK_LINES: Dict[str, str] = {
    ...
    "Kill Team Champion": "The Kill Team Champion who masters the long-range approach gives the team its longest reach — the cloak covering the approach, the scope finding the angle, the shot removing what the team could not otherwise safely close on.",
...
TERMINUS_SLAYER_TACTICAL_RANK_LINES: Dict[str, str] = {
    ...
    "Lord Executioner": "The Lord Executioner's mandate specifies no preferred method. Versatility is the fullest expression of that mandate — the auspex identifies the weakpoint; the weapon is selected accordingly.",
    ...
    "Company Champion": "The Company Champion who masters every approach is the Chapter's most complete expression — every weapon applied, every weakpoint addressed, no approach refused.",
    "Kill Team Champion": "The Kill Team Champion who masters every approach is the team's most complete asset — the auspex identifies what the team cannot close on alone, and the Champion selects from every approach available to address it.",
...
TERMINUS_SLAYER_VANGUARD_RANK_LINES: Dict[str, str] = {
    ...
    "Kill Team Champion": "The Kill Team Champion who fires the grapnel closes on what the team cannot. The grapnel launches before the formation reaches the target; the engagement at close quarters removes the threat before it can reverse the distance.",
